...
%   http://www.isr.uc.pt/~henriques/
	...
	boxes = cell(num_frames,1); % returns a vector of empty arrays of length num_frames
...
scroll(frame);      
%         boxes{frame} = [100 150, 38,44];
% 		scroll(frame);
%   rec = rectangle('Position',[100,100,90,90],'EdgeColor','r','LineWidth',1);        
		stop = stop_tracker;
	end
